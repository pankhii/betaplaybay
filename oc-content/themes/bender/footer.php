...
if($i=="0"){	  ?>
	 <a title="Russian language"  class="rusiian-btn" href="<?php echo osc_change_language_url ( osc_locale_code() ); ?>"><img alt="Russian language" src="<?php echo osc_current_web_theme_url('images/russian-flag.png');?>" alt=" "></a>
	 <?php }elseif($i=='1'){?>
	 <a title="Engish(US) language" class="english-btn" href="<?php echo osc_change_language_url ( osc_locale_code() ); ?>"><img alt="Engish(US) language" src="<?php echo osc_current_web_theme_url('images/english-flag.png');?>" alt=" "></a>
	 <?php } ?>
	 <?php $i++; ?>
	 <?php }}?>
 </div> 
